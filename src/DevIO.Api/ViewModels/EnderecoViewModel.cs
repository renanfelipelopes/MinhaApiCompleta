...
namespace DevIO.Api.ViewModels
{
    public class EnderecoViewModel
    {
        ...
        [Required(ErrorMessage = "0 campo {0} é obrigatório")]
        [StringLength(50, ErrorMessage = "0 campo {0} precisa ter entre {2} e {1} caracteres", MinimumLength = 1)]
        ...
        [Required(ErrorMessage = "0 campo (0} é obrigatório")]
        [StringLength(8, ErrorMessage = "0 campo {0} precisa ter {1} caracteres", MinimumLength = 8)]
